        ...
        <View column auto>
          <Toolbar style={{backgroundColor:"#fff"}}>
            <ToolbarGroup key={0}>
              ...
              <SelectField ref="device" selectedIndex={this.state.deviceIndex} displayMember="device_model_short" valueMember="device_id" menuItems={this.state.devices} onChange={this.onSelectDevice} style={{float:"left", marginTop:"5px", width:"300px"}} />
            </ToolbarGroup>
